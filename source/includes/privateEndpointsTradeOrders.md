...
fetch("https://api.sparrowsandbox.com/trades/book/BTC-SP$?type=call", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
url = URI("https://api.sparrowsandbox.com/trades/book/BTC-SP$?type=call")
...
payload = ''
headers = {}
conn.request("GET", "/book/BTC-SP$?type=call", payload, headers)
res = conn.getresponse()
data = res.read()
print(data.decode("utf-8"))
```
...
func main() {
  ...
  url := "https://api.sparrowsandbox.com/trades/book/BTC-SP$?type=call"
  method := "GET"
