...
### URL Endpoint
`https://api.sparrowsandbox.com/trades/book/own?filter=buy`
...
## GET - Display own buy trades - custom
...
### URL Endpoint
`https://api.sparrowsandbox.com/trades/book/own?filter=buy&status=closed&orderby=expiry&order=asc`
...
### URL Endpoint
`https://api.sparrowsandbox.com/trades/book/own?filter=sell`
...
## GET - Display own sell trades - custom
...
### URL Endpoint
`https://api.sparrowsandbox.com/trades/book/own?filter=sell&orderby=expiry&order=asc`
